...
#   #file         = $fileLocation
#
#   softwareName  = 'template-cli*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
#
...
# Create shortcut
# $shortcutFilePath = Join-Path $env:Public "YourApplication.lnk"
# $targetPath = Join-Path $installDir "your-application.jar"
# Install-ChocolateyShortcut -ShortcutFilePath $shortcutFilePath -TargetPath $targetPath

# Optionally, register with system services or perform any other necessary configurations

...
class TemplateWithHiltCLI : CliktCommand() {
    ...
    private fun createProjectFolderAndStartProjectSetup(
        ...
        "git clone https://github.com/audibhavesh-fermion/android-native-hilt.git ${appName}".runCommand(File(
            originalPath
        ), onFailure = {
            ...
            callWhenHiltRepoCloned(projectFolderPath, originalPath, appName, packageName, mainFileName)
        })


    }

    private fun callWhenHiltRepoCloned(
    ...
    private fun createMainDirectory(
        ...
        val constantsPath = "$mainPath/constants"
        val diPath = "$mainPath/di"
        val networkPath = "$mainPath/network"
        val mainUiPath = "$mainPath/ui/main"
        val homeUiPath = "$mainPath/ui/home"

        listOf(uiPath, constantsPath, configPath, diPath, networkPath, mainUiPath, homeUiPath).forEach {
            File(it).mkdirs()
        }
        ...
        createFile(
            "$constantsPath/CacheHolder.kt", """
                 package ${packageName}.constants

                import com.fermion.android.base.constants.BaseCacheHolder
                
                class CacheHolder:BaseCacheHolder() {
        ...
        createFile(
            "$diPath/${mainFileName}Application.kt", """
                        ...
                        import com.fermion.android.base.di.BaseHiltApplication
                        import dagger.hilt.android.HiltAndroidApp

                        @HiltAndroidApp
                        class ${mainFileName}Application : BaseHiltApplication() {
                        }
                """
        )
        ...
        createFile(
            "$diPath/${mainFileName}AppModule.kt", """
                      package ${packageName}.di
                      ...
                      class ${mainFileName}AppModule {
                          @Singleton
                          @Provides
                          fun provideApplication(@ApplicationContext app: Context): ${mainFileName}Application {
                              return app as ${mainFileName}Application
                          }
        ...
        createFile(
            "$mainUiPath/${mainFileName}Activity.kt", """
              ...
              class ${mainFileName}Activity :
                  ...
                  override fun obtainViewModel(): Lazy<${mainFileName}ViewModel> {
                      return viewModels()
                  }
            ...
            "$homeUiPath/HomeFragment.kt", """
                package ${packageName}.ui.home
                 ...
                 class HomeFragment : BaseFragment<FragmentHomeBinding, HomeViewModel>() {
                     ...
                     override fun obtainViewModel(): Lazy<HomeViewModel> {
                         return viewModels()
                     }
                 }
                    """.trimIndent()
    ...
    private fun createResFolder(
        ...
        val resCopyPath = "$projectFolderPath/examples/cats-facts/src/main/res"
